...
export default {
  ...
  computed: {
    ...
    submitButtonColor() {
      return this.isEditingNutrient ? "success" : "primary";
    },
    submitButtonText() {
      return this.isEditingNutrient ? "Modificar Nutriente" : "Crear Nutriente";
    },
  },
  methods: {
    ...{
    ...
    submitForm() {
      ...
      const eventName = this.isEditingNutrient
        ? "submit-edit"
        : "submit-create";

      this.$emit(eventName, {
        ...(this.isEditingNutrient && {
