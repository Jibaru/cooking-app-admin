  ...
  <form @submit.prevent="submitFilter">
    <div class="row">
      ...
      <div class="form-group col-12 col-sm-12 col-md-4 col-lg-2 center">
        ...
        >
          <prefs-ingredients v-model="selectedIngredientOptions" />
        </base-modal>
        <base-popover
        ...
        >
          <base-simple-list
            v-if="selectedIngredientOptions.length > 0"
...
export default {
  ...
  computed: {
    selectedIngredientValues() {
      return this.selectedIngredientOptions.map((option) => option.value);
    },
    selectedIngredientKeys() {
      return this.selectedIngredientOptions.map((option) => option.key);
    },
  },
  methods: {
    ...
    submitFilter() {
      const filters = {
        ...
        ...(this.selectedIngredientOptions.length > 0 && {
          prefsIngredients: this.selectedIngredientKeys,
        }),
      };
