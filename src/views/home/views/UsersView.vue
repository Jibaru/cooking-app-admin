<template>
  <base-card>
    ...
    <users-filter @filter="searchUsers" />
  </base-card>
  <base-card>
    <users-table />
  </base-card>
  ...
  >
    <create-user-form @submit-create="closeModalAndCreateUser" />
  </base-modal>
</template>
<script>
import UsersFilter from "@/components/app/user/forms/filter/UsersFilter";
import UsersTable from "@/components/app/user/tables/UsersTable";
...
export default {
  ...
  methods: {
    ...
    closeModalAndCreateUser(userData) {
